...
extension URLSession {
    ...
    ///
    public func object<Object: Codable>(from url: URL, using decoder: JSONDecoder) async throws -> Object {
    ...
    ///
    public func object<Object: Codable>(for request: URLRequest, using decoder: JSONDecoder) async throws -> Object {
